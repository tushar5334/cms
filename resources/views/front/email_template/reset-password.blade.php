                        ...
                        <tr>
                            <td style=" vertical-align: top; text-align: center; padding: 50px 20px 30px 20px;">
                                ...
                                <p style="margin: 0 0 30px;">
                                    ...
                                    <a style="background: #78be20; display: inline-block; color: #ffffff; padding: 14px 30px; font-weight: 700; text-decoration: none; border-radius: 6px; font-size: 15px;" href="{{ $mailcontent['reset_url'] }}">RESET PASSWORD</a>
                                    <span style="display: block; clear: both;"></span>
                                </p>
